...
%>
<p>Guestbook '${fn:escapeXml(agape-schedulerName)}' has no messages.</p>
<%
} else {
%>
<p>Messages in Guestbook '${fn:escapeXml(agape-schedulerName)}'.</p>
<%
...
<form action="/sign" method="post">
    ...
    <input type="hidden" name="agape-schedulerName" value="${fn:escapeXml(agape-schedulerName)}"/>
</form>

<form action="/agape-scheduler.jsp" method="get">
    <div><input type="text" name="agape-schedulerName" value="${fn:escapeXml(agape-schedulerName)}"/></div>
